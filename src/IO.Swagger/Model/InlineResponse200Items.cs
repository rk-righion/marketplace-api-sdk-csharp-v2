...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse200Items :  IEquatable<InlineResponse200Items>, IValidatableObject
    {
        ...
        public InlineResponse200Items(List<string> Expands = default(List<string>), string Sku = default(string), string ProductGroup = default(string), string Department = default(string), string ProductType = default(string), string Brand = default(string), string Name = default(string), string Description = default(string), string Color = default(string), string Flavor = default(string), string Gender = default(string), string ManufacturerCode = default(string), string Size = default(string), string EanIsbn = default(string), double? Height = default(double?), double? Width = default(double?), double? Depth = default(double?), double? Weight = default(double?), string Video = default(string), List<InlineResponse200ItemsImages> Images = default(List<InlineResponse200ItemsImages>), List<InlineResponse200ItemsAttributes> Attributes = default(List<InlineResponse200ItemsAttributes>), List<InlineResponse200ItemsLinks> Links = default(List<InlineResponse200ItemsLinks>))
        {
