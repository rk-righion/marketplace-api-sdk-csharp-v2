...
namespace IO.Swagger.Model
{
    ...
    public partial class Body3 :  IEquatable<Body3>, IValidatableObject
    {
        ...
        public Body3(double? ListPrice = default(double?), double? SalePrice = default(double?))
        {
            // to ensure "ListPrice" is required (not null)
            if (ListPrice == null)
            {
                throw new InvalidDataException("ListPrice is a required property for Body3 and cannot be null");
            }
            else
            {
            ...
            if (SalePrice == null)
            {
                throw new InvalidDataException("SalePrice is a required property for Body3 and cannot be null");
            }
            else
            {
