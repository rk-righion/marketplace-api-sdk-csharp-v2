...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceRequest :  IEquatable<PriceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceRequest(double? ListPrice = default(double?), double? SalePrice = default(double?))
        {
            // to ensure "ListPrice" is required (not null)
            if (ListPrice == null)
            {
                throw new InvalidDataException("ListPrice is a required property for PriceRequest and cannot be null");
            }
            else
            {
            ...
            if (SalePrice == null)
            {
                throw new InvalidDataException("SalePrice is a required property for PriceRequest and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PriceRequest);
        }
