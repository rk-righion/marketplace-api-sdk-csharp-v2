...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceResponse :  IEquatable<PriceResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceResponse(double? ListPrice = default(double?), double? SalePrice = default(double?), List<InlineResponse200ItemsLinks> Links = default(List<InlineResponse200ItemsLinks>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PriceResponse);
        }

        /// <summary>
        /// Returns true if PriceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PriceResponse to be compared</param>
        /// <returns>Boolean</returns>
